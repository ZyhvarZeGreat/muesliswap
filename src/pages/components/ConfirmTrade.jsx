...
import {
  transferADA,
  transferADAAndTokens,
} from "../../lib/walletUtils/walletUtils";
    ...
    <Dialog>
      <DialogTrigger>
        <div className="sc-gEvEer eLaKli w-full">
          <button className="sc-gEvEer eWXwvT w-full">Swap Instantly</button>
        </div>
      </DialogTrigger>
      <DialogContent className="p-2.5 rounded-2xl max-w-[500px] ">
        ...
        <div
          className=" bg-blue-400 sc-dhKdcB bOsUiC"
          tabIndex="-1"
          role="dialog"
          aria-modal="true"
          style={{
        ...
        >
          <p className="sc-gEvEer gWtCjc">
            After submitting to the blockchain, the trade will be executed as
            soon as market price reaches your desired price.
          </p>
          <p className="sc-gEvEer kpVmdW">
            Note: The transaction cannot be reversed after being executed.
          ...
          <div className="sc-gEvEer sc-eqUAAy  mt-2 enRBfD fgprtA">
              ...
              <div className="sc-gEvEer sc-eqUAAy jQCsrt fgprtA">
                ...
                >
                  <img
                    src={
                      topInputValue.info
                        ? topInputValue.info.image
                        : ` ${
                            isBase64(topInputValue.icon)
                ...
                <span className="sc-gEvEer Mglgv">
                  {Number(topInputValue?.quantity) / 1000000}
                </span>
              </div>
              <span className="sc-gEvEer hHuoiF">
                {" "}
                {topInputValue.info
                  ? topInputValue.info.symbol
                  : topInputValue.name}
              </span>
            </div>
            <svg
            ...
            <div className="sc-gEvEer sc-eqUAAy eVbqNG fgprtA">
              <div className="sc-gEvEer sc-eqUAAy jQCsrt fgprtA">
                ...
                <span className="sc-gEvEer Mglgv">
                  {(Number(bottomInputValue?.quantity) / 1000000).toFixed(2)}
                </span>
              </div>
              <span className="sc-gEvEer hHuoiF">
                {" "}
            ...
            <div className="sc-gEvEer gSgSkJ">
              <div display="flex" className="sc-gEvEer inczKp">
                ...
                <div
                  height="100%"
                  overflow="hidden"
                  className="sc-gEvEer sc-eqUAAy Eavop fgprtA"
                >
            ...
            <div className="sc-gEvEer fBPmVO">
              The market price can change while you place a trade. Any pending
              trades on the blockchain can be found in{" "}
              <a href="/wallet/orders">Open orders</a>.
            </div>
          </div>
          <button
            onClick={() => {
