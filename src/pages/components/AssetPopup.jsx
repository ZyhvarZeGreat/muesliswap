...
const AssetPopup = (props) => {
  const { totalAssets, setTopInputValue, topInputValue } = props;
  ...
  const checkIcon = isBase64(topInputValue?.icon)

  console.log(filteredAssets, topInputValue);
    ...
    <Dialog>
      <DialogTrigger className="w-1/2 ">
        <div className="sc-gEvEer sc-eqUAAy  ">
          {state.isWalletConnected && topInputValue ? (
            <button
              type="button"
            ...
            >
              ...
              >
                <img
                  src={topInputValue.info ? topInputValue.info.image : ` ${isBase64(topInputValue.icon) ? 'data:image/png;base64,' : ''} ${topInputValue.icon}`}
              ...
              <p fontSize="16px" className="sc-gEvEer ivXQsU">
                {topInputValue.info ? topInputValue.info.symbol : topInputValue.name}
              </p>
        ...
        <div className="w-full font-gilroy">
          <div className="w-full flex gap-4 flex-col">
            ...
            <div className="sc-bbSZdi px-4 w-full flex flex-col dzKiJQ">
              ...
              <div
                className="sc-fBWQRz  flex flex-col w-full gBAYwp"
                style={{
                  position: "relative",
                  height: "400px",
                  width: "100%",
